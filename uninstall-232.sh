...
envsubst < ./frontend/k8s/deployment-232.yaml | kubectl delete -f - || echo "Frontend deployment not found."
envsubst < ./frontend/k8s/configmap-232.yaml | kubectl delete -f - || echo "Frontend configmap not found."
envsubst < ./backend/k8s/deployment-232.yaml | kubectl delete -f - || echo "Backend deployment not found."
envsubst < ./backend/k8s/configmap-232.yaml | kubectl delete -f - || echo "Backend configmap not found."
